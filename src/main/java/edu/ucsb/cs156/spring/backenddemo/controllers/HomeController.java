...
public class HomeController {
    ...
    public static String getHomePageObjectJSON(String baseUrl) throws JsonProcessingException {
        ...
        team.add("Kole Kikuta");
        team.add("Rohan Marangoly");
        team.add("Alexander Nguyen");
        team.add("Hao Yi");
        team.add("Justin Zhang");
        team.add("Hongye Liang");
        resultMap.put("team", team);
        resultMap.put("repo", "https://github.com/ucsb-cs156-w24/team01-w24-4pm-4");
